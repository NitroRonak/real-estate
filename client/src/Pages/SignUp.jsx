  ...
  return (
      <div className='w-11/12 sm:w-4/12 mx-auto my-20'>
        ...
        <form className='flex flex-col gap-5' onSubmit={handleSubmit}>
          ...
          <button disabled={loading} className='p-3 border bg-blue-400 text-white border-gray-500 rounded-md text-xl text-transform: uppercase hover:bg-blue-500 hover:text-white transition-all delay-75 hover:tracking-[.15em] disabled:opacity-80' type='submit'>
