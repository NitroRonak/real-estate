...
const ListingCard = ({listing}) => {
  return (
    <div className='bg-white shadow-lg hover:scale-105 hover:border-2 hover:border-orange-400 transition-all duration-300 ease-in-out overflow-hidden rounded-lg w-full sm:w-[320px]'>
